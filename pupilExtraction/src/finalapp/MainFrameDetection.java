        ...
        public void run() {
            synchronized (this) {
                ...
                while(true){
                    b= System.currentTimeMillis(); 
                     calibBool=false;
                     Image im=pu.processFrame(webSource,false,0,op);
                ...
                position=false;
                    ...
                    //tranfer the camera object to fetch and process each frame
                     Image im=pu.processFrame(webSource,false,10,op);
                     BufferedImage buff = (BufferedImage) im;
                     g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
//              
            }}
        ...
        int count=0;
         ...
         long b;
                while(bool){
                        ...
                        try {
                            BufferedImage buff=ImageIO.read(new File(new String("calibration"+method+".png")));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,method,op);

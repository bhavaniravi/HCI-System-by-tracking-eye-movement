...
public class MainFrameDetection extends javax.swing.JFrame {
 ...
 static boolean cCenter=true,cULeft=true,cURight=true,cBLeft=true,cBRight=true;
   /**
 *@see DaemonThread
 * @version 1.0
                ...
                while (true) {
                    ...
                    EyeGaze pu= new EyeGaze();
                     long a= System.currentTimeMillis(); 
                        ...
                        try {
                            see.setText("See Center");
                            BufferedImage buff=ImageIO.read(new File("calibration1.png"));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,1);
                        ...
                        try {
                              see.setText("2");
                            BufferedImage buff=ImageIO.read(new File("calibration2.png"));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,2);
                        } catch (IOException ex) {
                            ex.printStackTrace();
                        }
                        ...
                        try {
                            BufferedImage buff=ImageIO.read(new File("calibration3.png"));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,3);
                        } catch (IOException ex) {
                            ex.printStackTrace();
                        }
                        ...
                        try {
                            BufferedImage buff=ImageIO.read(new File("calibration4.png"));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,4);
                        } catch (IOException ex) {
                            ex.printStackTrace();
                        }
                        ...
                        try {
                            BufferedImage buff=ImageIO.read(new File("calibration5.png"));
                              g.drawImage(buff, 0, 0, getWidth(), getHeight()-150 , 0, 0, buff.getWidth(), buff.getHeight(), null);
                              pu.processFrame(webSource,true,5);
                        } catch (IOException ex) {
                            ex.printStackTrace();
                        }
...
//              
    ...
    private void calibrateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calibrateActionPerformed
        // TODO add your handling code here:
        cCenter=true;cULeft=true;cURight=true;cBLeft=true;cBRight=true;
